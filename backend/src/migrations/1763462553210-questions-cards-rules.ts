...
export class QuestionsCardsRules1763462553210 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "questions" ("id" SERIAL NOT NULL, "title_en" text NOT NULL, "title_zh" text, "options_en" jsonb, "options_zh" jsonb, "active" boolean NOT NULL DEFAULT true, "weight" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_08a6d4b0f49ff300bf6b74a9e1b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cards" ("id" SERIAL NOT NULL, "code" character varying(120) NOT NULL, "name_en" text NOT NULL, "name_zh" text, "image_url" text, "default_meaning_en" text, "default_meaning_zh" text, "enabled" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_cards_code" UNIQUE ("code"), CONSTRAINT "PK_5e0a53c53d7e2d753dd61b825e3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "rules" DROP CONSTRAINT "FK_rules_question"`,
    );
