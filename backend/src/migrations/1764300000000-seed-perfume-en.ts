...
export class SeedPerfumeEn1764300000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE perfumes SET product_name_en = product_name, brand_name_en = brand_name`,
    );
    ...
    const updates = [
      {
        ...
        scene_choice: 'A. 玫瑰园',
        description_en:
          "The Fool's innocence opens a new emotional journey. Fresh roses bring pure emotion to new acquaintances or renewed relationships.",
      ...
      },
      {
        ...
        description_en:
          "The Fool's free soul finds belonging in warm wood, suitable for establishing a stable emotional foundation.",
      ...
      },
      {
        ...
        description_en:
          "The Fool's adventurous spirit joins the warmth of coffee, injecting intimate moments of deep conversation into the relationship.",
      ...
      },
      {
        ...
        description_en:
          "The Fool's sincerity is purified through the soapy scent, returning feelings to their simple and pure essence.",
