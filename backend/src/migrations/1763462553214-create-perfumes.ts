...
export class CreatePerfumes1763462553214 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'card_name', type: 'varchar', length: '120', isNullable: false },
          { name: 'scene_choice', type: 'varchar', length: '255', isNullable: false },
          { name: 'brand_name', type: 'varchar', length: '255', isNullable: false },
          ...
          { name: 'status', type: 'varchar', length: '30', isNullable: false, default: "'active'" },
    ...
    await queryRunner.createUniqueConstraint(
      'perfumes',
      new TableUnique({ name: 'UQ_perfumes_card_scene', columnNames: ['card_id', 'scene_choice'] }),
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropUniqueConstraint('perfumes', 'UQ_perfumes_card_scene');
