    ...
    const updates = [
      {
        ...
        description_en: "The Magician represents the spark of creation. Like a rose garden in early summer, it signifies the beginning of a beautiful romance. You have all the tools you need to manifest the love you desire.",
      ...
      },
      {
        ...
        description_en: "The Magician's resourcefulness meets the grounding warmth of wood. This scent embodies the power to transform the ordinary into the extraordinary, grounding your potential in reality.",
      ...
      },
      {
        ...
        description_en: "A blend of mystery and mastery. The Magician invites you to explore the depths of your potential. Like a dark cafe, it offers a space for deep conversation and magical connections.",
      ...
      },
      {
        ...
        description_en: "Pure potential and clarity. The Magician clears the way for new beginnings. This crisp, clean scent reflects a mind ready to create and a heart open to fresh possibilities.",
