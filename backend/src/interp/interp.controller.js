...
let InterpretationController = class InterpretationController {
    ...
    async matchRule(body) {
        ...
        const cardCodes = cardIndices.map((idx) => String((idx % 78) + 1).padStart(2, '0'));
        // 2) 用卡牌默认解读拼接合成结果
        ...
        const summary = ((_a = interpretations[1]) === null || _a === void 0 ? void 0 : _a.sentence) ||
            ((_b = interpretations[0]) === null || _b === void 0 ? void 0 : _b.sentence) ||
            ((_c = interpretations[2]) === null || _c === void 0 ? void 0 : _c.sentence) ||
            '';
