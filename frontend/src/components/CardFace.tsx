...
export const CardFace = memo(({ id, variant = 'wheel' }: CardFaceProps) => {
    // Position logic:
    ...
    return (
        <div className={clsx(
            ...
            "bg-[#14100F]",
            "bg-[radial-gradient(circle_at_center,#2E241D_0%,#0F0B0A_100%)]",
            ...
            <div className="absolute inset-0 p-1 z-10">
                ...
                <svg viewBox="0 0 140 90" className="w-full h-full">
                    ...
                    <g stroke="url(#decoGold)" strokeWidth="1" fill="none" strokeLinecap="square">
                    ...
                    <g transform={`translate(${textPos.x}, ${textPos.y})`}>
                         {/* Corner Accent */}
                         <path d="M -8 -8 L 8 -8 L 8 8" fill="none" stroke="url(#decoGold)" strokeWidth="0.5" opacity="0.8" transform={variant === 'wheel' ? "" : "rotate(-90)"} />
